...
def save_request(
    ...
    quarter,
    doc_path,
    budget_cost_reimbursable="",
    budget_approved_in_workforce_plan="",
    budget_status="",
    budget_primary_objective="",
    budget_demand_utilization_change="",
    budget_estimated_cost="",
    budget_contractor_conversion="",
    budget_additional_info="",
    location_offshore_possible="",
    ...
    request_row = {
        ...
        "Quarter": quarter,
        "Cost Reimbursable Project": budget_cost_reimbursable,
        "Approved in Workforce Plan": budget_approved_in_workforce_plan,
        "Budget Status": budget_status,
        "Primary Business Objective": budget_primary_objective,
        "Demand Utilization Change": budget_demand_utilization_change,
        "Estimated Position Cost": budget_estimated_cost,
        "Contractor Temp Conversion Details": budget_contractor_conversion,
        "Additional Position Information": budget_additional_info,
        "Can Position Be Offshored": location_offshore_possible,
        "Offshore No Reason": location_offshore_no_reason,
...
def submit_request_dialog():
    ...
    if st.button(
        ...
        # Capture Justification and Budget tab values before saving to Data.xlsx
        budget_cost_reimbursable = st.session_state.get("budget_cost_reimbursable", "")
        budget_approved_in_workforce_plan = st.session_state.get("budget_approved_in_workforce_plan", "")
        budget_status = st.session_state.get("budget_status", "")
        budget_primary_objective = st.session_state.get("budget_primary_objective", "")
        budget_demand_utilization_change = st.session_state.get("budget_demand_utilization_change", "")
        budget_estimated_cost = st.session_state.get("budget_estimated_cost", "")
        budget_contractor_conversion = st.session_state.get("budget_contractor_conversion", "")
        budget_additional_info = st.session_state.get("budget_additional_info", "")
        location_offshore_possible = st.session_state.get("location_offshore_possible", "")
        location_offshore_no_reason = st.session_state.get("location_offshore_no_reason", "")
